# Generated by Django 2.1.7 on 2019-11-11 05:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(blank=True, db_column='Date', null=True)),
                ('completeBacklog', models.IntegerField(blank=True, db_column='CompleteBacklog', null=True)),
                ('totalBacklog', models.IntegerField(blank=True, db_column='TotalBacklog', null=True)),
